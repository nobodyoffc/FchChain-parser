...
public class DataMaker {
	...
	public static void readBlockFile() throws IOException, InterruptedException {
		...
		while(true) {
			...
			System.out.println("Readed new block :"+BytesTools.bytesToHexStringLE(Hash.Sha256x2(b80)));
	...
	public static String getLastId(BlockParts blockParts) {
		...
		return BytesTools.bytesToHexStringLE(Hash.Sha256x2(blockParts.getB80()));
	}
	...
	public static BlockParts replacePreId(BlockParts blockParts1, String preId) {
		...
		System.out.println("This blockId is :"+ BytesTools.bytesToHexStringLE(Hash.Sha256x2(blockParts.getB80())));
	...
	public static BlockParts readBlock(int fileOrder, long pointer) throws IOException {
		...
		System.out.println("Readed block: "+BytesTools.bytesToHexStringLE(Hash.Sha256x2(b80)));
